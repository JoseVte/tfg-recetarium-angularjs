...
recetarium.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
    ...
    $routeProvider
        ...
        .when('/reset/password/:token', {
            templateUrl: 'views/auth/recover-password.html',
...
authController.controller('ResetPassword', ['$scope', '$rootScope', '$location', 'AuthService', '$timeout', 'NotificationProvider',
    function($scope, $rootScope, $location, AuthService, $timeout, NotificationProvider) {
...
authController.controller('RecoverPassword', ['$scope', '$rootScope', '$routeParams', '$location', 'AuthService', '$timeout', 'NotificationProvider',
...
authController.controller('EditProfile', ['$scope', '$rootScope', '$location', 'AuthService', '$timeout', 'NotificationProvider',
    function($scope, $rootScope, $location, AuthService, $timeout, NotificationProvider) {
...
homeController.controller('Header', ['$scope', '$rootScope', '$mdSidenav', '$timeout', '$location',
...
homeController.controller('Home', ['$scope', '$rootScope', '$location', 'RecipeService', 'NotificationProvider', 'DIFF',
...
recipeController.constant('EDIT_FUNCTIONS', {
    ...
    CommonFunctions: function($scope, $rootScope, $location, $timeout, $compile,
        ...
        $scope.getVisibilityIcon = function(visibility) {
            return VISIBILITY.icon[visibility];
        };

        $scope.getVisibilityClass = function(visibility) {
            return VISIBILITY.class[visibility];
        };
...
recipeController.controller('RecipeShow', ['$scope', '$rootScope', '$location', '$routeParams', '$sce', 'RecipeService', 'NotificationProvider', 'DIFF', 'VISIBILITY',
...
recipeController.controller('RecipeCreate', ['$scope', '$rootScope', '$location', '$timeout', '$compile',
    'RecipeService', 'CategoryService', 'TagService', 'IngredientService',
    'NotificationProvider', 'DIFF', 'VISIBILITY', 'FILE_DROPZONE', 'EDIT_FUNCTIONS',
...
recipeController.controller('RecipeEdit', ['$scope', '$rootScope', '$location', '$timeout', '$compile', '$routeParams',
    'RecipeService', 'CategoryService', 'TagService', 'IngredientService',
    'NotificationProvider', 'DIFF', 'VISIBILITY', 'FILE_DROPZONE', 'EDIT_FUNCTIONS',
    ...
    function($http, $rootScope, envService, $q) {
        ...
        service.getImages = function(recipe) {
            ...
            var main = mainImage ? {
                ...
                href: service.apiUrl + '/recipes/' + recipe.id + '/media/' + mainImage.filename
            } : {
            ...
            for (var i = 0; i < recipe.media.length; i++) {
                ...
                if (image !== mainImage) gallery.push({
                    id: image.id,
                    title: filename,
                    href: service.apiUrl + '/recipes/' + recipe.id + '/media/' + image.filename
                });
            }
