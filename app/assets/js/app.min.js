...
authController.controller('Logout', ['$scope', '$location', 'AuthService',
...
recipeController.controller('RecipeAll', ['$scope', '$rootScope', '$location', '$sce', 'RecipeService', 'NotificationProvider',
...
recipeController.controller('RecipeShow', ['$scope', '$rootScope', '$location', '$routeParams', '$sce', 'RecipeService', 'NotificationProvider',
    function($scope, $rootScope, $location, $routeParams, $sce, RecipeService, NotificationProvider) {
        ...
        $scope.getDifficulty = function(dif) {
            return diffs[dif];
        }
    }
]);
...
authServices.factory('AuthService', ['$http', '$rootScope', '$timeout', 'envService',
...
recipeService.factory('RecipeService', ['$http', '$rootScope', 'envService',
